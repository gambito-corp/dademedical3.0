<div>
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        <div class="mb-4 flex flex-wrap items-center">
            ...
            <div class="w-full md:w-6/12 md:pr-2 mb-4 md:mb-0">
                <label for="role" class="block mb-1 text-gray-700">Roles</label>
        ...
        <input type="submit" id="theme-toggle" class="px-4 py-2 rounded bg-blue-500 text-white hover:bg-blue-600 focus:outline-none transition-colors" value="Editar" />
