                    ...
                    <div class="bg-white rounded-lg w-1/2">
                        <div class="flex flex-col items-start p-4">
                            <div class="flex items-center w-full">
                                <div class="text-gray-900 font-medium text-lg">Confirmar eliminación de usuario {{optional($user)->name}}</div>
                            ...
                            <div class="ml-auto mr-5 mt-5 mb-3">
                                <input type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" value="Si, eliminar usuario">
